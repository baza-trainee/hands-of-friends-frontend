		...
		<div className='bg-lightBlue'>
			...
			>
				...
				<button
					...
					type='button'
					className=' block min-w-[198px] min-h-[60px] mx-auto rounded-md underline underline-offset-4 px-0 mt-8 font-normal bg-transperent text-black border border-transparent hover:border hover:border-deepBlue md:mt-10 xl:mt-8'
				>
					{t('btn')}
				</button>
				<NewsModal
