...
function Page({ lng }) {
  ...
  return (
    <div>
      <div className="bg-image-about bg-center h-[275px] md:min-h-[440px] xl:min-h-[734px] 2xl:min-h-[825px]">
        <Container>
          <BreadCrumbs
            className="mb-[177px] mt-[16px] md:mt-[41px] md:mb-[206px] xl:mb-[445px] 2xl:mb-[511px] z-10"
            href="/"
            text={t("breadcrumbs")}
            textColor="white"
          />
